...
const NavigationMobile = () => {
  ...
  return isOpen ? (
    <nav className="header__nav--open">
      <button
        className="header__nav__button--open"
      ...
      <div className="header__nav--style">
        ...
        <Link className="header__nav__link" to={`/invoices`}>
          Invoices
        </Link>
        <Link className="header__nav__link" to={`/companies`}>
          Companies
        </Link>
        <Link className="header__nav__link" to={`/contacts`}>
          Contacts
        </Link>
      </div>
    </nav>
    ...
    <div className="header__nav--closed">
      <button
        className="header__nav__button--closed"
